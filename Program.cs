...
namespace ClosedXML_OutputListCompare
{
    public class TsTable
    {
        public int No { get; set; }
        public List<string> LocNo { get; set; } = new List<string> { };
    }
    ...
    class Program
    {
        static void Main()
        {
            ...
            List<TsTable> tsTableList = new() { tsTable1, tsTable2 };
